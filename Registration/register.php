...
<body>
	...
	<div class="row container formsection" style="margin-top: 20px;">
		...
		<form action="register.php" method="POST" class="col s12 l5 black-text" autocomplete="new-password">
			<div class="row">
				<div class="input-field col l12 s12">
					<!-- Name -->
					<label class="black-text" for="">Username</label>
					<input class="black-text" required placeholder="username" id="username"
			...
			<div class="row">
				<div class="input-field col l12 s12">
					...
					<input class="black-text" required placeholder="Name" id="name"
			...
			<div class="row">
				<div class="col s12 m4 l4">
					...
					<select name="blood" id="blood" class="validate" required>
						<option selection disabled>Select</option>
			...
			<div class="row">
				<div class="input-field col s12 l12">
					...
					<input class="black-text" required placeholder="Contact Number"
			...
			<div class="row">
				<div class="input-field col s12 l12">
					...
					<input class="black-text" required placeholder="password"
						id="cpassword" name="cpassword" type="password" class="validate">
				</div>
			</div>
			...
			<div>
				...
				<button class="btn waves-effect waves-light red lighten-1" name="register" type="submit">Register
	...
	<footer>
		<span>All Copyright Reserved | <span class="far fa-copyright"></span> 2021 <a href="./index.html" style="text-decoration: none;">Red Friend</a></span>
	</footer>
	...
	if(isset($_POST['register']))
	{
	  ...
	  if($query_run)
	  {
		...
		else
		{
		  ...
		  {
			$query = "insert into user values('$usid', '$username', '$name', '$gender', '$blood',  '$phone', '$city' , '$address', '$password')";
			$query_run = mysqli_query($con,$query);

			if($query_run)
			{
			  echo '<script type="text/javascript">alert("Registration Succesful! Welcome")</script>';
			  echo "<script> location.href='../Donor login/donorlogin.php'; </script>";
