...
<body>
	...
	<ul class="sidenav" id="mobile-demo">
		...
		<li><a class="btn red" href="/bank?blood=&city=&zeros=on">Search Donors</a></li>
	</ul>


	<!-- Crap -->

	<div class="row container formsection" style="margin-top: 20px;">
		<div class="center black-text">
			<h4>Create or Log in to a profile to continue</h4>
		</div>
		<div class="col l6 hide-on-med-and-down offset-l1 center" style="transform: translateY(16%);">
			<img src="./img/donate.jpg" alt="Donate" class="center">
		</div>
		<form class="col s12 l5 black-text" action="/register" method="POST" autocomplete="new-password">
			<div class="row">
				<div class="input-field col l12 s12">
					<!-- Name -->
					<label class="black-text" for="">Username</label>
					<input autocomplete="new-password" class="black-text" required placeholder="Username" id="first_name"
						name="usname" type="text" class="validate"><!-- for php code-->
				</div>
			</div>
			<div class="row">
				<div class="input-field col l12 s12">
					<!-- Name -->
					<label class="black-text" for="">Name</label>
					<input autocomplete="new-password" class="black-text" required placeholder="Name" id="first_name"
			...
			<div class="col s12 m8 l8">
				...
				<p class=" black-text">
					...
					<label>
						<input class="with-gap black-text white" value="Other" name="gender" type="radio" required />
			...
			<div class="row">
				...
				<div class="col s12 m8 l8">
					...
					<p class=" black-text">
						<label>
							<input class="with-gap black-text white" value="+" name="rh" type="radio" required />
							<span class="black-text">Positive</span>
						</label>
						<label>
							<input class="with-gap black-text white" value="-" name="rh" type="radio" required />
							<span class="black-text">Negative</span>
						</label>
					</p>
				</div>
			</div>
			...
			<div class="row">
				<div class="input-field col s12 l12">
					...
					<input autocomplete="new-password" class="black-text" required placeholder="Contact Number"
						id="phone" name="phone" type="text" pattern="[789][0-9]{9}" class="validate">
				</div>
			</div>
			...
			<div class="row">
				<div class="input-field col s12 l12">
					...
					<input autocomplete="new-password" class="black-text" required placeholder="password"
			...
			<div class="row">
				<div class="col s12 l12">
					...
					<select name="city" id="city" class="validate" required="">
						...
						<option value="Srisailam Project (Right Flank Colony) Township">Srisailam Project (Right Flank
							Colony) Township</option>
			...
			<div class="row" id="final">
				<div class="input-field col s12 l12 m12">
					<textarea autocomplete="new-password" maxlength="80" id="address" placeholder="Enter your Address"
						name="address" class="materialize-textarea black-text validate" required></textarea>
			...
			<div>
				<label class="black-text">
					...
					<span class="black-text">I confirm that I am atleast 18 years old.</span><br>
				</label>
				<button class="btn waves-effect waves-light red lighten-1" type="submit">Register
	...
	<footer>
		<span>All Copyright Reserved | <span class="far fa-copyright"></span> 2021 <a href="./index.html"
				style="text-decoration: none;">Red
				Friend</a></span>
	</footer>
	<?php
	...
	if(isset($_POST['register']))
	{
	  ...
	  if($query_run)
	  {
		...
		else
		{
		  ...
		  {
			$query = "insert into user values('$usid', '$Username', '$gender', '$name', '$Bloodgroup',  '$contact', '$Rhfactor', '$password', '$city' , '$address')";
			$query_run = mysqli_query($con,$query);
